...
if(_message == "Enter a Message") exitwith { ["Musisz wprowadzić prawidłową wiadomość.", true] spawn domsg;  };
...
if(_type == 0) then {
    ...
    ["anonymous", format["%1 (%2) wysłał wiadomość do %3 (%4) mówiąc - %5", name player, getplayeruid player, name _status, getplayeruid _status, _message]] remoteExec ["server_fnc_log",2];
};