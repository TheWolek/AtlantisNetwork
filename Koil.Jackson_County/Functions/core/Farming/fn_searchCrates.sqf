...
if (_target IN searchedcrates) exitwith { ["Ostatnio przeszukałeś tę skrzynkę", true] spawn domsg; };
...
if(_chance > 75) then {
	...
	["Nic nie znalazłeś.",false] spawn domsg;
};

if(_chance > 95) THEN {
	player additem "NP_kPelt";
	["Znalazłeś bardzo rzadką skórkę!",false] spawn domsg; 
};
