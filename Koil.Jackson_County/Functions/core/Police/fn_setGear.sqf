...
if(myJob == "EMS") then {
	...
	if(_type == "EMS") then {
		...
		player forceAddUniform "CUP_U_C_Rescuer_01"; 
		...
		if(female) then { 
			...
			if(_level == 2) then { player forceAddUniform "CG_EMS1"; };
			if(_level == 4) then { player forceAddUniform "CG_EMS3"; };
			if(_level == 5 || _level == 6) then { player forceAddUniform "CG_EMS5"; };
			if(_level > 6) then { player forceAddUniform "CG_EMS8"; };
