...
_Btn4 ctrlSetStructuredText parsetext format["Atlantis County v. %1 <br/> Officer %2 <br/> Entered %3 <br/> <br/> Crime: %4", _suspect select 0, _suspect select 0, _time, _crime];
_btn4 ctrlCommit 0;