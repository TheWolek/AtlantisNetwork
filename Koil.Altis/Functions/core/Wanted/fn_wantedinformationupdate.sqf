...
switch(_status) do {
    ...
    case 0: {
        ...
        _Btn4 ctrlSetStructuredText parsetext format["Atlantis County v. %1<br/>%2<br/>%3<br/>Utworzono w %4<br/>Przesłane przez %5<br/><br/>%6", toUpper(_suspect), _type, _closedperson, _created_at, _officer, _crime];
    };
    case 1: {
        _type = "ARREST WARRANT";
        _Btn4 ctrlSetStructuredText parsetext format["Atlantis County v. %1<br/>%2<br/>%3<br/>Utworzono w %4<br/>Przesłane przez %5<br/>%6<br/><br/>%7", toUpper(_suspect), _type, _closedperson, _created_at, _officer, _approved, _crime];
    };
    case 2: {
        if (_evidence == 0) then {
    ...
    case 4: {
        ...
        _Btn4 ctrlSetStructuredText parsetext format["Atlantis County v. %1<br/>%2<br/>%3<br/>Utworzono w %4<br/>Przesłane przez %5", toUpper(_suspect), _type, _closedperson, _created_at, _officer];
    }; 
    case 5: {
