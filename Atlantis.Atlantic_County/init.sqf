...
d14b1deb795274d657c7ccc174a56a56 = true;
540d211c987e87d34971ab299aa21763 = true;
A_Police_01_T = true;
...
if (isServer) then {
	...
	GarageVariableWhore = "Flag_US_F" createVehicle [0,1,0];
	 ...
	 evidenceBox = createVehicle ["c_supplycrate_f", [6978.6,4033.71,1], [], 0, "CAN_COLLIDE"]; 
...
//CAMERA SHIT s
	...
	_attempt = isClass (ConfigFile >> "CfgVehicles" >> "ivory_cv_marked");
