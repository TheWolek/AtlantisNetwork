...
if(_type == "license") then {
	...
	if(_adjust == "Add") then { 
		...
		if( !(_amount IN licenseArray) ) then {
			...
			if(_amount == 8) then { [getplayeruid player, 8, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję PD SWAT Leader Certification.",false] spawn domsg; };
			if(_amount == 9) then { [getplayeruid player, 9, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję PD SWAT Certification.",false] spawn domsg; };
			if(_amount == 10) then { [getplayeruid player, 10, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję PD Scuba Leader Certification.",false] spawn domsg; };
			if(_amount == 11) then { [getplayeruid player, 11, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję PD Scuba Certification.",false] spawn domsg; };
			if(_amount == 12) then { [getplayeruid player, 12, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję PD Air Leader Certification.",false] spawn domsg; };
			if(_amount == 13) then { [getplayeruid player, 13, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję PD Air Certification.",false] spawn domsg; };
			...
			if(_amount == 19) then { [getplayeruid player, 19, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś Casino Membership.",false] spawn domsg; };
			...
			if(_amount == 23) then { [getplayeruid player, 23, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję FD Air Leader Certification.",false] spawn domsg; };
			if(_amount == 24) then { [getplayeruid player, 24, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję FD Air Certification.",false] spawn domsg; };
			...
			if(_amount == 26) then { [getplayeruid player, 26, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję FD Scuba Certification.",false] spawn domsg; };
			if(_amount == 27) then { [getplayeruid player, 27, 1] remoteExec ["server_fnc_licenses",2]; ["Otrzymaeś licencję Paralegal.",false] spawn domsg; };
	...
	if(_adjust == "Remove") then { 
		...
		if( (_amount IN licenseArray) ) then {
			...
			if(_amount == 8) then { [getplayeruid player, 8, 2] remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję PD SWAT Leader Certification.",false] spawn domsg; };
			if(_amount == 9) then { [getplayeruid player, 9, 2] remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję PD SWAT Certification.",false] spawn domsg; };
			if(_amount == 10) then { [getplayeruid player, 10, 2] remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję PD Scuba Leader Certification.",false] spawn domsg; };
			if(_amount == 11) then { [getplayeruid player, 11, 2] remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję PD Scuba Certification.",false] spawn domsg; };
			if(_amount == 12) then { [getplayeruid player, 12, 2] remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję PD Air Leader Certification.",false] spawn domsg; };
			if(_amount == 13) then { [getplayeruid player, 13, 2] remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję PD Air Certification.",false] spawn domsg; };
			...
			if(_amount == 19) then { [getplayeruid player, 19, 2] remoteExec ["server_fnc_licenses",2]; ["Utraciłeś Casino Membership.",false] spawn domsg; };
			...
			if(_amount == 23) then { [getplayeruid player, 23, 2 remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję FD Air Leader Certification.",false] spawn domsg; };
			if(_amount == 24) then { [getplayeruid player, 24, 2 remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję FD Air Certification.",false] spawn domsg; };
			...
			if(_amount == 26) then { [getplayeruid player, 26, 2 remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję FD Scuba Certification.",false] spawn domsg; };
			if(_amount == 27) then { [getplayeruid player, 27, 2 remoteExec ["server_fnc_licenses",2]; ["Utraciłeś licencję Paralegal.",false] spawn domsg; };
