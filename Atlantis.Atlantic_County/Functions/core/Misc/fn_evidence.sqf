...
switch(_info select 10) do {
    ...
    case 1: {
        ...
        diag_log format ["Evidence_log: %1 (UID %2) discovered that a person shot somebody with a(n) %3. Witnessed by %4.", player, _uid , _info select 6, _witnesses]; 
    };
    ...
    case 2: {
        ...
        diag_log format ["Evidence_log: %1 (UID %2) discovered that a person strip searched somebody. Witnessed by %4.", player, _uid , _witnesses]; 
    };
    ...
    case 3: {
        ...
        diag_log format ["Evidence_log: %1 (UID %2) discovered that a person robbed a store using a(n) %3. Witnessed by %4.", player, _uid , _info select 6, _witnesses];        
