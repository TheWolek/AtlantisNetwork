...
if(_mayor) then { 
	...
	_house = nearestObject [[9949.03,3732.87,0.00143814], "Land_ark_bg_maison1"]; _higherup = true;
};
...
if(_mafia == 10) then {
	...
	_house = nearestObject [[2715.16,948.178,0.00143909], "Land_vvv_np_maison1"]; _higherup = true;
};
...
if(_cop == 9) then {
	...
	_house = nearestObject [[9516.43,3526.09,0.00143814], "Land_ark_bg_maison1"]; _higherup = true;
};

if(_ems == 10) then {

	_house = nearestObject [[9412.31,3479.1,0.00143814], "Land_ark_bg_maison1"]; _higherup = true;
};

if(_ems == 9) then {

	_house = nearestObject [[9306.67,3430.66,0.00143814], "Land_ark_bg_maison1"]; _higherup = true;
};

if(_legal == 10) then {

	_house = nearestObject [[9188.22,3371.8,0.00143814], "Land_ark_bg_maison1"]; _higherup = true;
};

if(_legal == 9) then {
	_house = nearestObject [[9094.99,3324.16,0.00143814], "Land_ark_bg_maison1"]; _higherup = true;
};
...
if(_higherup) exitwith { 
	...
	if(_houselevel == 2) then {
		_nObject = nearestObjects [_house, ["Land_Ranch_DED_Ranch_02_F","Land_Ranch_DED_Ranch_01_F","Land_HouseC_R","Land_HouseC1_L","Land_HouseA1_L","Land_HouseB1_L","Land_ark_bg_maison1"], 30];   
		_containerpos = (_nobject select 0) getrelpos [15,0];  
		player setpos _containerpos;
	};

	if(_houselevel == 3) then {
		_nObject = nearestObjects [_house, ["Land_HouseDoubleAL","Land_HouseDoubleAL2","Land_ark_bg_maison1"], 30];   
		_containerpos = (_nobject select 0) getrelpos [15,0];  
		player setpos _containerpos;
	};
