...
if(mafiabank < _amountcheck) exitwith { ["Mafii nie stać na to. Jaki wstyd.. ", true] spawn domsg; };

[format["Otrzymałeś pożyczkę w wysokosci %1 - musisz oddać %2",_amountcheck,_owed], true] spawn domsg;
