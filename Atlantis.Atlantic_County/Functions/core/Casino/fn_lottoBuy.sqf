...
format["MoneyLog: %1 (%2) bought %3 worth of lottery tickets. Bank: %4; Cash: %5", name player, getplayeruid player, 1000*(1+casinoRate/100) call client_fnc_numberText, player getVariable "cashinbank", player getVariable "cashinhand"] remoteExecCall["diag_log",2];
