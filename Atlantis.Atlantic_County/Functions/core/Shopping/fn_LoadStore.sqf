...
["TRYK_U_B_BLK_T_BG_BK",nil,50,3,1],
        ...
        ["vvv_character_agente_47",nil,100,3,1],
        ["vvv_character_agente_472",nil,100,3,1],
        ["vvv_character_agente_473",nil,100,3,1],
        ["vvv_character_agente_474",nil,100,3,1],
        ["vvv_character_agente_475",nil,200,3,1],
        ["vvv_ropa_comun_f_1",nil,100,3,1],
        ["vvv_ropa_comun_f_2",nil,100,3,1],
        ["vvv_ropa_comun_f_3",nil,100,3,1],
        ["vvv_ropa_comun_f_5",nil,100,3,1],
        ["vvv_character_rock1",nil,500,3,1],
        ["EF_MKJKT",nil,100,3,1],
        ["EF_MKJKT2",nil,100,3,1],
        ["EF_M_jkt1_3",nil,100,3,1],
        ["EF_M_jkt2_4",nil,100,3,1],
        ["EF_HM_LPBW2",nil,100,3,1],
        ["EF_HM_LPB2",nil,100,3,1],
        ["EF_HM_LPBL2",nil,100,3,1],
        ["U_BG_Guerilla1_1",nil,100,3,1],
        ["Gsg9_Uniform_TrainingBlack_Gloves",nil,100,3,1],
        ["Gsg9_Uniform_TrainingBrown_Gloves",nil,100,3,1],
        ["Gsg9_Uniform_TrainingWetEarth_Gloves",nil,100,3,1],
        ["Gsg9_Uniform_TrainingBlack",nil,100,3,1],
        ["Gsg9_Uniform_TrainingBrownWhiteTs",nil,100,3,1],
        ["Gsg9_Uniform_TrainingBrownWhiteTS_Gloves",nil,100,3,1],
        ["Gsg9_Uniform_TrainingWetEarthWhiteTS_Gloves",nil,100,3,1],
        ["TRYK_U_B_ARO1_BLK_R_CombatUniform",nil,300,3,1],
        ["TRYK_U_B_ARO1_CBR_R_CombatUniform",nil,300,3,1],
        ["TRYK_U_B_ARO1_GR_R_CombatUniform",nil,300,3,1],
        ["TRYK_U_B_ARO1_GRY_R_CombatUniform",nil,300,3,1],
        ["TRYK_U_B_ARO2R_CombatUniform",nil,300,3,1],
        ["TRYK_U_B_AOR2_BLK_R_CombatUniform",nil,300,3,1],
        ["TRYK_U_B_AOR2_GRY_R_CombatUniform",nil,300,3,1],
        ["TRYK_U_B_AOR2_OD_R_CombatUniform",nil,300,3,1],
        ["TRYK_U_B_PCUHsW7",nil,300,3,1],
        ["TRYK_U_B_BLK3CD_Tshirt",nil,300,3,1],
        ["TRYK_U_B_BLKTAN_Tshirt",nil,300,3,1],
        ["TRYK_U_B_BLK_OD_Tshirt",nil,300,3,1],
        ["TRYK_U_B_ODTAN_Tshirt",nil,300,3,1],
        ["TRYK_OVERALL_SAGE_BLKboots_nk_blk2",nil,100,3,1],
        ["TRYK_OVERALL_SAGE_BLKboots_nk_blk",nil,100,3,1],
        ["TRYK_OVERALL_SAGE_BLKboots",nil,100,3,1],
        ["TRYK_U_B_NATO_OCP_BLK_c_R_CombatUniform",nil,100,3,1],
        ["TRYK_OVERALL_SAGE_BLKboots_nk_blk2",nil,100,3,1],
...
if(_condition == "general") then {
	...
	_generalGroceries = [
		...
		["murshun_cigs_matches",nil,5,3],
		["murshun_cigs_cigpack",nil,40,3],
		["murshun_cigs_lighter",nil,20,3],
		["np_ugroceries",nil,35,3],
...
if(_condition == "police_veststore") then {
	...
	_police_veststoree = [
		...
		["TRYK_V_Bulletproof_BLK",nil,1,3,3],
