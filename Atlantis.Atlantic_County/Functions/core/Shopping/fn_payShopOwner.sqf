...
diag_log format ["PlayerStore_Log: %1 bought %2 of %3 for %4 from %5 Taxes: %6.",_shopclient ,_quantity, _item, _totalprice call client_fnc_numberText, player ,(_totalPrice-(_totalPrice/(1+taxRate/100))) call client_fnc_numberText];
