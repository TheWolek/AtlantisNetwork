...
if(!taskrunning) then {
	...
	[] spawn {
		playertasks = [];
		taskrunning = true;
		busStoparray = [[[6297.1,1343.93,1.05324],"South Silver Lake City"],[[6444.65,2070.45,0.00143814],"Silver Lake City"],[[7759.63,2541.55,0.00143814],"North Silver Lake City"],[[9767.67,3439.07,0.00143814],"North Silver Lake Housing"],[[9601.8,4155.65,0.00143814],"Ivywood Hospital"],[[8755.99,5788.11,0.00143814],"Ivywood Courthouse"],[[8661.25,6934.1,0.00143814],"Colchester City"],[[5420.71,6286.56,0.00109863],"Silver Lake Jail"],[[6728.49,4552.73,0.00143862],"Morrison Casino"],[[5493.53,3786.18,0.00143886],"Morrison Central"],[[4973.07,2483.28,0.00143886],"Morrison South"],[[1370.65,2531.7,0.00143623],"Oakheart"],[[261.468,7276.82,0.00143886],"Doncaster"],[[905.981,7521.7,0.00143886],"Rajon End"],[[4130.93,2167.28,0.00133896],"Skystead Turnoff"],[[3444.73,1343.02,0.00145721],"Silverlake Airport"],[[4964.65,1213.92,0.00143814],"South Silver Lake Housing"]];
		_warnings = 0;
		uisleep 30;
		...
		while{taskrunning && myjob == "bus"} do {
			...
			if(playertasks isequalto []) then {
				...
				if(player distance ((playertasks select 0) select 0) < 15) then {
					...
					_pia = [[6297.1,1343.93,1.05324],[6444.65,2070.45,0.00143814],[7759.63,2541.55,0.00143814],[9767.67,3439.07,0.00143814],[9601.8,4155.65,0.001438144],[8755.99,5788.11,0.00143814],
