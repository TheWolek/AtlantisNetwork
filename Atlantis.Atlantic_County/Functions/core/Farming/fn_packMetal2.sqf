...
*/
	if(vehSpawned distance player > 15 || isNil {vehSpawned} || isnull vehSpawned ) exitwith { ["Ciężarówka jest za daleko!", true] spawn domsg; }; 
	if(totalLogs == 6) exitwith { ["Ciężarówka jest pełna!", true] spawn domsg; };
