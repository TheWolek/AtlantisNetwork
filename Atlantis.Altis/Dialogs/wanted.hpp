...
class yn_Menu {
	...
	class controls {
		...
		class QuestionToAsk : client_RscStructuredText
		{
			type = 13;
			style = 0;
			text = "Zostałeś wezwany na ławie przysięgłych - czy chcesz go zaakceptować? Płatność wynosi $2000.";
...
class wanted {
	...
	class controls {
		...
		class LookupCrimes : client_RscButtonMenu {
			idc = 1005;
			text = "Przestępstwa wyszukiwania";
 		...
 		class SelectInformationControlsGroup : client_RscControlsGroup {
            ...
            class controls {
				class SelectInformation: client_RscStructuredText
				{
					...
					font="PuristaLight";
					text = "Nie wybrano żadnego przestępstwa.";
					size = 0.035;
					sizeEx = 0.05;
					x = 0;
					y = 0;
...
class insertPBA { // cops and da - arrest warrant
	...
	class controls {
		...
		{
			idc = 1116;
			text = "To jest oficjalny dokument sądowy. Musisz opisać wydarzenia, które doprowadziły do aresztowania tej osoby. Nie uwzględniaj opłat. Musisz być zwięzły i opisowy. Nieprzestrzeganie właściwego formatu spowoduje postępowanie dyscyplinarne, a także odmowę aresztowania i skazania podejrzanego.";
			autocomplete = "";
			sizeEx = 0.030;
			x = 0.517817 * safezoneW + safezoneX;
			y = 0.28933 * safezoneH + safezoneY;
...
class insertSearchHouse { // cops and da - arrest warrant
	...
	class controls {
		...
		{
			idc = 1116;
			text = "Wprowadź powód przeszukania i zajęcia domu osoby.";
			autocomplete = "";
			sizeEx = 0.030;
			x = 0.517817 * safezoneW + safezoneX;
			y = 0.28933 * safezoneH + safezoneY;
...
class insertSearchShop { // cops and da - arrest warrant
	...
	class controls {
		...
		{
			idc = 1116;
			text = "Wprowadź powód przeszukania i zajęcia w sklepie osoby";
			autocomplete = "";
			sizeEx = 0.030;
			x = 0.517817 * safezoneW + safezoneX;
			y = 0.28933 * safezoneH + safezoneY;
