...
*/
	...
	if!(surfaceIsWater (getpos _vehicle)) exitwith {
		["Straciłeś swój dynamit!", true] spawn domsg;
		deletevehicle _vehicle;
	};

	_catchPos = (getpos _vehicle);
	["Udany rzut - Czekaj!", true] spawn domsg;
	...
	["Podejdź bliżej, aby podnieść!", true] spawn domsg;
	...
	} else { ["Nie złapałeś swojej ryby na czas!", true] spawn domsg;};				
